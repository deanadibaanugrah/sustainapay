...
const translations = {
  en: {
    home: "Home", dashboard: "Dashboard", transactions: "Transactions", carbonImpact: "Carbon Impact", recommendations: "Recommendations", rewards: "Rewards", profile: "Profile",
    title: "Sustaina-AI Insights History", subtitle: "Review your past carbon reduction tips and suggestions generated by AI.",
    analyzing: "Loading your AI insight history...", totalEmissions: "Emissions:", fetchFail: "Failed to load AI history.", serverFail: "Failed to connect to backend server.", noHistory: "No AI insights found yet. Make a transaction to generate one!", carbonSavings: "Carbon Savings", viewInfo: "View Info"
  },
  id: {
    home: "Beranda", dashboard: "Dasbor", transactions: "Transaksi", carbonImpact: "Dampak Karbon", recommendations: "Rekomendasi", rewards: "Hadiah", profile: "Profil",
    title: "Riwayat Saran AI Gemini", subtitle: "Tinjau kembali saran dan tips pengurangan karbon yang dihasilkan oleh AI dari transaksi Anda.",
    analyzing: "Sedang memuat riwayat saran AI...", totalEmissions: "Emisi:", fetchFail: "Gagal memuat riwayat saran AI.", serverFail: "Terjadi kesalahan jaringan ke backend server.", noHistory: "Belum ada riwayat saran AI. Lakukan transaksi untuk mulai mendapatkan insight!", carbonSavings: "Hemat Karbon", viewInfo: "Lihat Info"
  }
};
      ...
      <nav className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-xl border-b border-gray-100 shadow-sm transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <Link to="/" className="flex items-center gap-3 hover:opacity-80 transition group">
            <div className="w-10 h-10 bg-gradient-to-br from-[#00A651] to-green-700 flex items-center justify-center rounded-xl shadow-lg shadow-green-200 group-hover:scale-105 transition-transform"><span className="text-white font-black text-[10px] tracking-widest">LOGO</span></div>
